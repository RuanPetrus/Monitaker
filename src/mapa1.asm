...
LINHA6:	.word 0,7,0,0,0,0,0,0
LINHA7:	.word 0,0,0,0,0,0,0,0

MATRIZ: .word LINHA0,LINHA1,LINHA2,LINHA3,LINHA4,LINHA5,LINHA6,LINHA7 # pontero
PLAYER_APOS: .byte 1,1  # Posicao antiga do jogador
PLAYER_POS: .byte 1,1 	# Indice do jogador (linha e coluna)
