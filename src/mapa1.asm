...
LINHA0:	.word 0,4,1,8,0,0,0,0
LINHA1:	.word 0,8,0,8,0,0,0,0
LINHA2:	.word 0,4,0,8,0,0,0,0
LINHA3:	.word 0,8,0,8,0,0,0,0
LINHA4:	.word 0,4,0,5,0,0,0,0
LINHA5:	.word 0,0,8,0,0,0,0,0
...
Player: .byte 0,2 	#Indice do jogador (linha e coluna)
